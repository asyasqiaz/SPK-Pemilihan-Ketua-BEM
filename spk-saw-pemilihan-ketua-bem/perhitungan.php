...
?>
  ...
  <body>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <p class="card-text">Melakukan normalisasi (R) matriks keputusan X berdasarkan rumus sesuai dengan jenis kriteria. 
                    Karena semua kriteria berjenis benefit, maka menggunakan rumus:
                    Rij = (Xij/max{Xij})</p>
                  </div>
    ...
    <tr>
        <th class="table-light" rowspan='2'>Alternatif</th>
        <th class="table-light" colspan='6'>Kriteria</th>
    </tr>
    <tr>
        <th class="table-light">C1</th>
        <th class="table-light">C2</th>
        <th class="table-light">C3</th>
        <th class="table-light">C4</th>
        <th class="table-light" colspan="2">C5</th>
    </tr>
    <?php
$sql = "SELECT
          a.id_alternative,
...
<table class="table caption-top mb-0">
    ...
    <tr>
        <th class="table-light" rowspan='2'>Alternatif</th>
        <th class="table-light" colspan='5'>Kriteria</th>
    </tr>
    <tr>
        <th class="table-light">C1</th>
        <th class="table-light">C2</th>
