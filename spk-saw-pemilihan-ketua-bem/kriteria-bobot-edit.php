                ...
                <div class="page-content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Data Kriteria & Bobot</h4>
                        </div>

                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <form action="kriteria-bobot-edit-act.php" method="POST">
                                    <div class="form-group">
                                        <label style="color:#607080;" for="basicInput">Kriteria</label>
                                    ...
                                    <div class="form-group">
                                        <label style="color:#607080;" for="basicInput">Bobot</label>
                                        <input type="text" class="form-control" name="weight" value="<?=$row['weight'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label style="color:#607080;" for="basicInput">Jenis</label>
